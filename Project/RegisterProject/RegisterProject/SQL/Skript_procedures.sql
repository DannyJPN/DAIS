...
insert into druzstvo(nazev,sezona,ID_oddilu,ID_ligy) values ('TJ Zákupy B','2018/2019',63,'2L')
go
...
declare @wins integer=0;
declare @loses integer=0;
