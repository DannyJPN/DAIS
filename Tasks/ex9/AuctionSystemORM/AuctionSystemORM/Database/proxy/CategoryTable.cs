...
namespace AuctionSystem.ORM.Mssql
{
    public class CategoryTable : CategoryTableProxy
    {
        ...
        /// Insert the record.
        /// </summary>
        protected override int insert(Category Category)
        {
        ...
        /// <returns></returns>
        protected override int update(Category Category)
        {
            Database db = new Database();
            db.Connect();
        ...
        /// Select records.
        /// </summary>
        protected override Collection<Category> select()
        {
            Database db = new Database();
            db.Connect();
        ...
        /// </summary>
        protected override Category select(int idCategory)
        {
            Database db = new Database();
            db.Connect();
        ...
        /// Delete the record.
        /// </summary>
        protected override int delete(int id)
        {
            Database db = new Database();
            db.Connect();
